      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            switch (ego_state) 
            {
                case keep_lane:
                {
                    ...
                    if (slow_vehicle)
                    {
                        ...
                        new_lane = current_lane + ChooseLane(safety_vehicles, relevant_vehicles, current_lane, car_s);
            ...
            double distances_forward[] = {30,60,90};
            int lanes[] = {current_lane,current_lane,current_lane};
